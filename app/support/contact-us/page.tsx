            ...
            <div className="w-full max-w-[1280px] mx-auto">
                <div className="block md:grid md:grid-cols-2 md:gap-x-16 md:gap-y-8">
                    ...
                    <p className={paragraphClass}>
                        ...
                        Customer Services Team at 020 3740 0744 during office hours.
                    ...
                    <p className={paragraphClass}>
                        ...
                        020 3740 0744 (international charges may apply).
                    </p>
                    ...
                    <p className={paragraphClass}>
                        ...
                        Support Team at 020 3740 0744 We are available Monday to Friday

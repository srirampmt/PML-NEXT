        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-6 lg:p-8 flex flex-col">
            ...
            <p className="text-[#4c4c4c] text-[12px] font-normal my-3 leading-relaxed">
              ...
              reversible Blue Lagoon Cruise excursion.
            </p>
  ...
  const deals = [
    {
      ...
      country: "CYPRUS",
      rating: 5,
      title: "Luxury All-Inclusive Holiday Including Room Upgrade and FREE Blue Lagoon Cruise Excursion",
      hotelName: "King Evelthon Resort & Spa Hotel",
      description: "Enjoy a luxurious all-inclusive experience at this 5-star beachfront resort featuring 9 pools, water sports, and exceptional dining. Your stay includes a complimentary room upgrade and a reversible Blue Lagoon Cruise excursion.",
      nights: 7,
      price: 1099,
    ...
    },
    {
      ...
      country: "MALDIVES",
      rating: 5,
      title: "Paradise Island Retreat with Overwater Villa and Spa Package",
      hotelName: "Ocean Paradise Resort & Spa",
      description: "Experience ultimate luxury in an overwater villa with direct ocean access. Includes daily spa treatments, sunset cruises, and world-class dining experiences.",
      nights: 7,
      price: 2499,
    ...
    },
    {
      ...
      country: "DUBAI",
      rating: 5,
      title: "Exclusive Desert & Beach Experience with Premium Transfers",
      hotelName: "Atlantis The Palm",
      description: "Discover luxury at Dubai's iconic resort with unlimited access to Aquaventure Waterpark, Lost Chambers Aquarium, and complimentary desert safari.",
      nights: 5,
      price: 1799,
    ...
    },
    {
      ...
      country: "SANTORINI",
      rating: 5,
      title: "Romantic Caldera View Suite with Private Pool and Wine Tasting",
      hotelName: "Grace Hotel Santorini",
      description: "Indulge in breathtaking caldera views from your private infinity pool. Package includes champagne breakfast, sunset wine tasting, and romantic dinner.",
      nights: 6,
      price: 1899,
              ...
              <div className="bg-white rounded-[8px] overflow-hidden border border-[#ececec] my-5 md:my-6">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-[8px] md:p-[16px] flex flex-col">
                    <div className="font-semibold text-[#4c4c4c] text-[14px] p-[4px]">CYPRUS</div>

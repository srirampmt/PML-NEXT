        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <textarea
              ...
              rows={4}
              className={`w-full bg-white px-3 py-3 text-[14px] outline-none border resize-none ${getBorderClass(
                "message"
              )}`}
          ...
          {/* Destination and Resort fields are hidden but data will be sent to backend as usual */}
          ...
          <div className="text-[12px] text-[#595858] text-center">
            ...
            <a className="underline" href="tel:02037400744">
              020 3740 0744
            </a>
          </div>
        </form>

              ...
              <ShareItem
                icon={
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_26_17309)">
                      <path
              ...
              <ShareItem
                icon={
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_26_17314)">
                      <path
              ...
              <ShareItem
                icon={
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_26_17325)">
                      <path
              ...
              <ShareItem
                icon={
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_26_17330)">
                      <path
                ...
                {copied ? (
                  ...
                  <>
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clip-path="url(#clip0_26_17337)">
                        <path

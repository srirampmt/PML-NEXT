        ...
        <div className="w-full max-w-[1280px] mx-auto pt-8 pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-32 mb-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <Link href="/contact" className="text-[16px] font-weight-500 font-light tracking-[0.04em] underline text-white hover:text-[#df8abd] transition-colors">
                  Send an enquiry
                </Link>
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center gap-6">
              ...
              <form className="flex flex-col sm:flex-row gap-3 flex-1 max-w-5xl">
                <input
                  type="text"
                  name="full_name"
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-6">
            <div className="flex-shrink-0">
              <img
                src="https://planmylux.s3.eu-west-2.amazonaws.com/travel-aware-logo.png"
                alt="Travel Aware"

...
const TrendingCarousel = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-2 mb-4 md:mb-16">
                ...
                <div className="flex-[0_0_auto] w-[300px] md:w-[360px] h-[436px] font-['Montserrat']">
                  <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 ease-in-out flex flex-col h-full border border-[#f0f0f0] hover:shadow-xl hover:border-[#e0e0e0]">
                    ...
                    <div className="p-[15px] flex-grow flex flex-col justify-start items-start text-left bg-white">
                      ...
                      <div className="bg-[#EDEDED] border border-[#DFDEDE] px-[5px] md:px-[9px] py-[9px] rounded-[11px] text-[12px] text-[#4c4c4c] font-medium mb-[9px] flex items-center justify-center leading-[1.3] w-full text-center">
                        {deal.extras}
                      </div>
...
const Top20Banner = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-2 my-6 md:my-10 font-['Montserrat']">
        ...
        <div className="absolute inset-0 flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-3 sm:gap-5 px-6 md:px-12">
          <div className="flex flex-row items-center gap-5">
            ...
            <div className="flex flex-col justify-center items-start">
              ...
              <a
                href="#"
                className="mt-4 bg-[#CB2187] text-white px-2 md:px-6 py-2 rounded-xl text-[11px] sm:text-sm font-medium hover:bg-[#f3f3f3] w-full sm:w-auto text-center"
              >

...
const TrendingCarousel = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-2 mb-16">
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-2 my-10">
      <div className="rounded-2xl overflow-hidden shadow-xl relative">
        <img
          ...
          className="sm:block hidden w-full h-[220px] object-cover"
        />

        <div className="w-full h-[220px] object-cover bg-[#92D8CC] sm:hidden"></div>

        <div className="absolute inset-0 flex justify-center sm:justify-start items-center gap-5 px-6 md:px-12">
          <svg
            width="99"
            height="116"
            viewBox="0 0 99 116"
          ...
          <div className="flex flex-col justify-center items-start">
            ...
            <a
              href="#"
              className="mt-4 bg-[#CB2187] text-white px-6 py-2 rounded-xl text-xs sm:text-sm font-medium hover:bg-[#f3f3f3]"
            >

      ...
      <div className="rounded-2xl overflow-hidden shadow-xl relative">
        ...
        <div className="absolute inset-0 flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-3 sm:gap-5 px-6 md:px-12">
          ...
          <div className="flex flex-col justify-center items-start">
            ...
            <a
              href="#"
              className="mt-4 bg-[#CB2187] text-white px-6 py-2 rounded-xl text-xs sm:text-sm font-medium hover:bg-[#f3f3f3] w-full sm:w-auto text-center hidden sm:block"
            >
          ...
          <a
              href="#"
              className="bg-[#CB2187] text-white px-6 py-2 rounded-xl text-xs sm:text-sm font-medium hover:bg-[#f3f3f3] w-full text-center sm:hidden"
            >
            Find Your Perfect Deal
          </a>
        </div>
